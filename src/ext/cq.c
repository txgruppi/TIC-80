...
{
    float* m2 = calloc(1, CUBE_SIZE * sizeof(float));
    s64* wt = calloc(1, CUBE_SIZE * sizeof(s64));
    s64* mr = calloc(1, CUBE_SIZE * sizeof(s64));
    s64* mg = calloc(1, CUBE_SIZE * sizeof(s64));
    s64* mb = calloc(1, CUBE_SIZE * sizeof(s64));
    ...
    u8 lut_r[MAXCOLOR], lut_g[MAXCOLOR], lut_b[MAXCOLOR];
    box cube[MAXCOLOR];
    u8* tag;
    s32 next;
    s64 i, weight;
    ...
    Hist3d(wt, mr, mg, mb, m2, Ir, Ig, Ib, size, Qadd);
